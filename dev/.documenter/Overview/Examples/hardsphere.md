...
# Tutorial 1: Evolution of a Population of Hard Spheres {#Tutorial-1:-Evolution-of-a-Population-of-Hard-Spheres}

In this tutorial we will consider a population of hard spheres which are homogenous in space. These spheres only interact via perfectly elastic collisions (a binary interaction), the cross section for which is given in [Binary Interaction Cross Sections](/DiplodocusCollisions/cross%20sections#Binary-Interaction-Cross-Sections). 
...
## Building the Gain and Loss Collision Matrices {#Building-the-Gain-and-Loss-Collision-Matrices}
...
First thing is to select the names of the four particles involved in the binary interaction $12\rightarrow34$. In Diplodocus, each particle is designated a unique three letter `string` to identify it. These unique identifiers are then used internally to define the properties of the particles (please refer to [Particles, Grids and Units](/Overview/conventions#Particles,-Grids-and-Units) for more details). In binary interactions, we follow the convention that the pairs of names (12) and (34) should be in alphabetical order. Therefore for the interaction between hard spheres the names are declared by:
...
## Checking the Gain and Loss Matrices {#Checking-the-Gain-and-Loss-Matrices}
...
![](assets/HardSphere/BadSphereSpectra.png)
...
![](assets/HardSphere/GoodSphereSpectra.png)
...
## Evolving the Spheres Through Phase Space {#Evolving-the-Spheres-Through-Phase-Space}
...
### Building Interaction and Flux Matrices {#Building-Interaction-and-Flux-Matrices}
...
![](assets/HardSphere/HardSphereIsTAndIPlotDark.svg)

![](assets/HardSphere/HardSphereFracNumDenPlotDark.svg)

![](assets/HardSphere/HardSphereFracEngDenPlotDark.svg)
