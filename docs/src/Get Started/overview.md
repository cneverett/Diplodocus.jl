...
More details of the framework and its numerical implementation can be found in the DIPLODOCUS series of papers, the first two are currently available [DiplodocusI](@citet) and [DiplodocusII](@citet)
