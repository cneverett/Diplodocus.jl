...
# Set initial conditions
    ...
    Initial_UnBoostedPowerLaw!(Initial,PhaseSpace,"Ele",pmin=1e3,pmax=1e5,Gamma=2.0,index=2.0,num_Init=1e6);
...
# ===== Run the Solver ================== #
    ...
    fileName = "Blazar_Ani_10div3.jld2";
    ...
    @time sol = Solve(Initial,scheme;save_steps=10,progress=true,fileName=fileName,fileLocation=fileLocation);

# ===== Load and Plot Results ================== # 

    fileLocation = pwd()*"\\examples\\Data";
    fileName = "Blazar_Iso.jld2";
    (PS_Iso, sol_Iso) = SolutionFileLoad(fileLocation,fileName);
    fileName = "Blazar_Ani_0.jld2";
    (PS_Ani0, sol_Ani0) = SolutionFileLoad(fileLocation,fileName);
    fileName = "Blazar_Ani_5.jld2";
    (PS_Ani5, sol_Ani5) = SolutionFileLoad(fileLocation,fileName);
    fileName = "Blazar_Ani_5div3.jld2";
    ...
    SSCBFieldDark = Diplodocus.DiplodocusPlots.BFieldObserverPlot([sol_Ani0,sol_Ani5div3,sol_Ani10div3,sol_Ani5,sol_Iso],[PS_Ani0,PS_Ani5div3,PS_Ani10div3,PS_Ani5,PS_Iso],52,0.1,plot_limits=(-17.0,7.0,-0.5,8.5),title=nothing,TimeUnits=CodeToSIUnitsTime,theme=DiplodocusDark())
    SSCBFieldLight = Diplodocus.DiplodocusPlots.BFieldObserverPlot([sol_Ani0,sol_Ani5div3,sol_Ani10div3,sol_Ani5,sol_Iso],[PS_Ani0,PS_Ani5div3,PS_Ani10div3,PS_Ani5,PS_Iso],52,0.1,plot_limits=(-17.0,7.0,-0.5,8.5),title=nothing,TimeUnits=CodeToSIUnitsTime,theme=DiplodocusLight())
